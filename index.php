    ...
    <h3 class="mb-2 h3">Data Hasil BMI</h3>
        <div class="col-md-12">
            <table class="table table-striped">
                ...
                $pasien2 = new BMIPasien("Bogi Alfaraz", 63, 169, 18, "Laki - Laki");
                $pasien3 = new BMIPasien("Meina Putri", 40, 155, 19, "Perempuan");
                $pasien4 = new BMIPasien("Senoaji Wasesa", 68, 158, 21, "Laki - Laki");
                $pasien5 = new BMIPasien("Della Arimurti", 50, 160, 20, "Perempuan");
